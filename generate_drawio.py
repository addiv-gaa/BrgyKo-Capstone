...
out_path = r'C:\Users\David\.gemini\antigravity\brain\f3c05154-c485-44ef-a038-b92aef49aa6b\level_1_dfd_gane_sarson.drawio'
...
def add_edge(source, target, label, bidirectional=False):
    ...
    cells_str += f'''
        <mxCell id="{edge_id}" style="{style}" edge="1" parent="1" source="{source}" target="{target}">
          <mxGeometry relative="1" as="geometry" />
        </mxCell>
        <mxCell id="{label_id}" value="{label}" style="edgeLabel;html=1;align=center;verticalAlign=middle;resizable=0;points=[];backgroundColor=#ffffff;fontColor=#333333;" vertex="1" connectable="0" parent="{edge_id}">
